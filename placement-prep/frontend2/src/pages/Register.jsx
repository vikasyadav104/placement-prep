...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 4. If the backend says "Error", show it nicely
...
<div style={{ 
  ...
  <span style={{ 
    ...
    WebkitTextFillColor: 'transparent' 
      ...
      {/* ========================================== */}
      {/* RIGHT SIDE: The Functional Register Form   */}
      {/* ========================================== */}
      <div style={{
        flex: 1,
        display: 'flex',
        ...
        <div style={{ width: '100%', maxWidth: '380px' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            {/* Full Name */}
            <div>
              <label style={{ display: 'block', fontSize: '13px', color: '#a1a1aa', marginBottom: '8px', fontWeight: '500' }}>Full Name</label>
              <input 
                type="text" 
                value={name}
            ...
            {/* Password */}
            <div>
              <label style={{ display: 'block', fontSize: '13px', color: '#a1a1aa', marginBottom: '8px', fontWeight: '500' }}>Password</label>
